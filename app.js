...
function takeCommand(message) {
    if (message.includes('hey') || message.includes('hello')) {
        speak("Hello Godzilla, How May I Help You?");
        speak("I can do many things, for example, I can search for you on the internet, open your favorite websites, tell you the time, and much more.");
        ...
        speak(finalText);
            ...
            else if ("How's the weather today?") {
            window.open("https://www.google.com/search?q=weather", "_blank");
            speak("Here is the weather report for today.");
        }
    else {
        window.open(`https://www.google.com/search?q=${message.replace(" ", "+")}`, "_blank");
